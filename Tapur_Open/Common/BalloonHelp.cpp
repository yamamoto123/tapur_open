...
//paak      m_fnAnimateWindow = (FN_ANIMATE_WINDOW)GetProcAddress(hUser32, _T("AnimateWindow"));
   else
      m_fnAnimateWindow = NULL;
...
//paak      wcx.lpszClassName = "BalloonHelpClassDS"; // name of window class 
...
//paak      wcx.lpszClassName = "BalloonHelpClass";
