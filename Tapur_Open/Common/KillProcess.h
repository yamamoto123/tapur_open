// KillProcess.h: CKillProcess クラスのインターフェイス
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_KILLPROCESS_H__203AD3BD_F8E2_477C_AF95_7CB54DCD53B9__INCLUDED_)
#define AFX_KILLPROCESS_H__203AD3BD_F8E2_477C_AF95_7CB54DCD53B9__INCLUDED_
...
public:
    ...
    bool KillProcess(IN const char* pstrProcessName, long timeout = 5000)
    {
        DWORD dwId;
        ...
        if(WaitForSingleObject(hProcess, timeout)
            !=WAIT_OBJECT_0)
        ...
        OUT DWORD& dwId)
    {
            ...
            &processInfo)))
        {
                ...
                // wee weee we found it
            {
				...
				// 他のログインユーザの同名プロセスは操作できないため、NULLが返る
				if (hResult) {
					break;
				}
                //break;
...
#endif // !defined(AFX_KILLPROCESS_H__203AD3BD_F8E2_477C_AF95_7CB54DCD53B9__INCLUDED_)
