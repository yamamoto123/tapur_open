                         ...
                         UINT uBalloonTimeout /*=10*/)
{
    ...
    _tcsncpy_s(m_tnd.szTip, sizeof(m_tnd.szTip)/sizeof(m_tnd.szTip[0]), szToolTip, m_nMaxTooltipLength-1);
    ...
    if (m_bWin2K && szBalloonTip)
    {
        ...
        _tcsncpy_s(m_tnd.szInfo, sizeof(m_tnd.szInfo)/sizeof(m_tnd.szInfo[0]), szBalloonTip, 255);
        if (szBalloonTitle)
            _tcsncpy_s(m_tnd.szInfoTitle, sizeof(m_tnd.szInfoTitle)/sizeof(m_tnd.szInfoTitle[0]), szBalloonTitle, 63);
        else
...
BOOL CSystemTray::SetTooltipText(LPCTSTR pszTip)
{
    ...
    _tcsncpy_s(m_tnd.szTip, sizeof(m_tnd.szTip)/sizeof(m_tnd.szTip[0]), pszTip, m_nMaxTooltipLength-1);
                              ...
                              UINT    uTimeout /*=10*/ )
{
    ...
    m_tnd.uFlags = NIF_INFO;
    _tcsncpy_s(m_tnd.szInfo, sizeof(m_tnd.szInfo)/sizeof(m_tnd.szInfo[0]), szText, 256);
    if (szTitle)
        _tcsncpy_s(m_tnd.szInfoTitle, sizeof(m_tnd.szInfoTitle)/sizeof(m_tnd.szInfoTitle[0]), szTitle, 64);
    else
        m_tnd.szInfoTitle[0] = _T('\0');
