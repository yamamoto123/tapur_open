...
tiff2png (tiffname, pngname, verbose, force, interlace_type,
          png_compression_level, _invert, gamma)
#else
tiff2png (tiffname, pngname, verbose, force, interlace_type,
...
*/
int Tiff_Png(char *tiffname, char *pngname)
{
//    return tiff2png(tiffname, pngname, FALSE, TRUE, PNG_INTERLACE_ADAM7, -1, FALSE, -1.0);
    return tiff2png(tiffname, pngname, FALSE, TRUE, PNG_INTERLACE_ADAM7, -1, TRUE, -1.0);
}
